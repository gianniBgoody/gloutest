  ...
  <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light px-5 py-2" style="background-color: #FAECDC;">
	    <div class="container-fluid">
		    <a class="navbar-brand" style="color: #542B20" href="<?= base_url('session')?>">
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto">
            <li class="nav-item">
              <a class="nav-link mx-2" style="color: #542B20" href="#">A propos</a>
            </li>
	          <li class="nav-item">
	            <a class="nav-link mx-2" style="color: #542B20" href="#">Gloutonnerie</a>
	          </li>
            <li class="nav-item">
              <a class="nav-link mx-2" style="color: #542B20" href="#">Contact</a>
            </li>
	        </ul>
        ...
        <section>
          <?= $this->renderSection('contenuAccueil') ?>
        </section> 
